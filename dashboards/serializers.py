...
class DashboardSerializer(serializers.Serializer):
    ...
    produto_sem_estoque = serializers.DecimalField(max_digits=30, decimal_places=2, required=False)
    produto_sem_marca = serializers.DecimalField(max_digits=30, decimal_places=2, required=False)
    total_valor_estoque = serializers.DecimalField(max_digits=30, decimal_places=2, required=False)
