...
class TitulospagarViewSet(ModuloRequeridoMixin, viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        """Cria um título a pagar usando serviço de negócio."""
        try:
    ...
    def update(self, request, *args, **kwargs):
        """Atualiza um título a pagar usando serviço de negócio."""
        try:
    ...
    def destroy(self, request, *args, **kwargs):
        """Exclui um título a pagar usando serviço de negócio."""
