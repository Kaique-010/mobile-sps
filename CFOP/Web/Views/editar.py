...
class CfopUpdateView(UpdateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        self.empresa_id = kwargs.get('empr') or request.session.get('empresa_id') or request.headers.get('X-Empresa') or request.GET.get('empresa')
    ...
    def get_object(self, queryset=None):
        ...
        return Cfop.objects.using(self.db_alias).filter(cfop_empr=empr, cfop_codi=codi).first()
