...
from GestaoObras.web.views.materiais import listar_materiais, listar_estoque_geral, listar_estoque_materiais, criar_movimento_material
...
urlpatterns = [
    ...
    path("estoque/", listar_estoque_geral, name="estoque_geral"),
    ...
    path("obras/<int:obra_id>/estoque/", listar_estoque_materiais, name="obras_estoque_list"),
