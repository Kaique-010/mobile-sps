...
class Filiais(models.Model):
    ...
    empr_ambi_nfe = models.CharField(max_length=1, blank=True, null=True)
    ...
    empr_regi_trib = models.CharField(max_length=1, blank=True, null=True)
    ...
    empr_ambi_nfec = models.IntegerField(blank=True, null=True)
