...
class GerarTitulosPedidoView(APIView):
    def post(self, request, slug=None):
        ...
        # Buscar o pedido para pegar empresa e filial
        try:
        ...
        valor_parcela = (pedi_tota / parcelas).quantize(Decimal("0.01"))
        
        # Ajuste para garantir que a soma das parcelas seja igual ao total
        diferenca = pedi_tota - (valor_parcela * parcelas)
        ...
        for i in range(parcelas):
            ...
            titulos.append(Titulosreceber(
                titu_empr=pedi_empr,
                titu_fili=pedi_fili,
                titu_seri="PEV",  # Série para pedidos
