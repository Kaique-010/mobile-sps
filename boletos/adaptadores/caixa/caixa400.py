...
from cnab400.caixa import HeaderArquivo, Detalhe, TrailerArquivo
from cnab400.retornos.caixa import CaixaRetorno400


class CaixaCnab400Adapter:
    ...
    def processar_retorno(self, caminho):
        retorno = CaixaRetorno400(caminho)
        dados = []
