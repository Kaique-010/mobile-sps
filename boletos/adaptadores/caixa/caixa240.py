...
from cnab240.remessa.caixa import Registro0, Registro1, Registro3P, Registro3Q
from cnab240.retornos.caixa import CaixaRetorno


class CaixaCnab240Adapter:
    def gerar_remessa(self, banco_cfg, cedente, titulos):
        ...
        for t in titulos:
            lote.incluir_registro(Registro3P(
                ...
                carteira=banco_cfg.get("carteira", "14"),
