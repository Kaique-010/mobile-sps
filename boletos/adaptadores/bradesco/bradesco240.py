...
from cnab240.remessa.bradesco import Registro0, Registro1, Registro3P, Registro3Q
from cnab240.retornos.bradesco import BradescoRetorno


class BradescoCnab240Adapter:
    def gerar_remessa(self, banco_cfg, cedente, titulos):
        ...
        for t in titulos:
            lote.incluir_registro(Registro3P(
                ...
                carteira=banco_cfg.get("carteira", "09"),
    ...
    def processar_retorno(self, caminho):
        retorno = BradescoRetorno(caminho)
        dados = []
