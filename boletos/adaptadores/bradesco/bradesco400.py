...
from cnab400.bradesco import HeaderArquivo, Detalhe, TrailerArquivo
from cnab400.retornos.bradesco import BradescoRetorno400


class BradescoCnab400Adapter:
    ...
    def processar_retorno(self, caminho):
        retorno = BradescoRetorno400(caminho)
        dados = []
