...
class ItauBoletoAdapter:
    """
    Gera boleto PDF Itaú.
    Usado por CNAB 240 e 400.
    """
    ...
    def gerar_pdf(self, titulo, cedente, sacado, banco_cfg, caminho):
        ...
        logo_path = banco_cfg.get("logo_path") or os.path.join(base_dir, "Logos", variation, str(banco_cfg.get("codigo_banco", "341")) + ".bmp")
        try:
