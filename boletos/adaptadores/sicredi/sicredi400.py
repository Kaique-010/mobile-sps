...
from cnab400.sicredi import HeaderArquivo, Detalhe, TrailerArquivo
from cnab400.retornos.sicredi import SicrediRetorno400


class SicrediCnab400Adapter:
    ...
    def processar_retorno(self, caminho):
        retorno = SicrediRetorno400(caminho)
        dados = []
