...
class ProdutosMassaTemplateView(TemplateView):
    template_name = "Produtos/produtos_massa.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx["api_url"] = reverse_lazy("produtos_massa_api_web", kwargs={"slug": self.slug})
        return ctx
